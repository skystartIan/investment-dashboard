...
git add invest_diary.html index.html app.js styles.css run_login.bat yuanta_config_server.py yuanta_sync.py yuanta_sync_guard.py yuanta_login_playwright.py yuanta_dividend_fetch.py yuanta_dividend_sync.py yuanta_web_dca.py yuanta_unrealized.py cleanup_downloads.py yuanta_task_watchdog.py check_yuanta_tasks.ps1 IB/apps-script-core.js IB/fetch_Yahoo.jst
